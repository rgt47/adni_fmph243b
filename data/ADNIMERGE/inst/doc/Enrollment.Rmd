...
This package vignette demonstrates how to use the [ADNIMERGE](index.html) package to generate simple enrollment and longitudinal summaries and plots with [R](http://www.r-project.org/) and [knitr](http://yihui.name/knitr/).
...
## Demographic Summaries by Diagnosis

### Baseline

```{r baselinesummary1, results = 'asis'}
...
```{r baselinesummarygo2, results = 'asis'}
